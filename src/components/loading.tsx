      ...
      >
        <style
          dangerouslySetInnerHTML={{
            __html:
              '.spinning-cog4420 {\n\t\t\tanimation: spinning-cog4420 1.3s infinite ease;\n\t\t\ttransform-origin: 50% 50%;\n\t\t\t/* Ensures the cog rotates around its center */\n\t\t}\n\n\t\t@keyframes spinning-cog4420 {\n\t\t\t0% {\n\t\t\t\ttransform: rotate(0deg);\n\t\t\t}\n\n\t\t\t100% {\n\t\t\t\ttransform: rotate(360deg);\n\t\t\t}\n\t\t}',
          }}
        />
        <g className="spinning-cog4420">
          <g>
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              fill="currentColor"
              d="M81.379,60.37c1.278-3.584,2.02-7.422,2.11-11.432
        ...
        <path
          ...
          d="M48,24c-13.255,0-24,10.745-24,24s10.745,24,24,24s24-10.745,24-24
